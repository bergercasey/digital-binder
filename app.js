...
(function(){
  ...
  function renderPanel() {
    ...
    (j.notes || []).forEach((n, i) => {
      ...
      if (isSel) { item.classList.add("selected"); try { item.style.boxShadow="0 0 0 3px var(--accent-300)"; item.style.borderRadius="10px"; item.style.background="var(--accent-25)"; } catch(e){} }
