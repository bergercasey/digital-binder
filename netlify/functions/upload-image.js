...
function parseDataUrl(dataUrl){ const m=/^data:([^;]+);base64,(.+)$/i.exec(dataUrl||''); if(!m) throw new Error('Invalid data URL'); return {contentType:m[1], data: Buffer.from(m[2],'base64')}; }
