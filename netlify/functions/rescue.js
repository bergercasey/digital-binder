...
<body>
  ...
  <div class='box'>
    <h2>LocalStorage</h2>
    <div class='row'>
      <button id='ls-list'>List keys</button>
      <button id='ls-backup'>Backup localStorage → JSON file</button>
    </div>
  ...
  <div class='box'>
    ...
    <p>Choose a JSON file previously exported (or a known-good backup). Uses a very high <code>serverVersion</code> so it wins.</p>
    <div class='row'>
